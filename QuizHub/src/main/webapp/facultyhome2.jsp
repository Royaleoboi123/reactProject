...
<html lang="en">
  ...
  <%if(username==null||role==null)
  {
    ...
    <div class="container" style="text-align: center">
      ...
      >
        <div
          class="col-6 bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center text-white overflow-hidden"
          style="user-select: auto"
        >
          <div class="my-3 py-3" style="user-select: auto">
            <h2 class="display-5" style="user-select: auto">Add Quiz</h2>
            <form action="">
              <button
                type="button"
                class="btn btn-warning position-relative m-lg-2"
        ...
        <div
          class="col-6 bg-light me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden"
          style="user-select: auto"
        >
          <div class="my-3 p-3" style="user-select: auto">
            ...
            <button
              ...
              class="btn btn-warning position-relative m-lg-2"
            >
              <h5><a href="adminDisplaSub.jsp">See here</a></h5>
            </button>
            <p class="lead" style="user-select: auto">
              And an even wittier subheading.
            </p>

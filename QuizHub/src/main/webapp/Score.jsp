  ...
  %>
        ...
        <div class="container-fluid">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <li><a class="dropdown-item" href="/">Web Tech</a></li>
                    <li><a class="dropdown-item" href="/">Advance Java</a></li>
                    <li><hr class="dropdown-divider" /></li>
                    <li>
                    <a class="dropdown-item" href="/">Other sub here</a>
                    </li>
                </ul>
                </li>
                <li class="nav-item">
	...
	<span style="color: white;">username:-</span>
        ...
        <div class="card text-center mb-5">
            ...
            <img src="http://www.mcicon.com/wp-content/uploads/2020/12/Education_Student_1-copy-8.jpg" width="50" />
            </div>
            <span class="name mb-1 fw-500"><%=username%></span>
            <div>
            <h1>
                <span><%=score%></span>
                <span>/</span>
          ...
          <div>Practice more to Improve..</div>

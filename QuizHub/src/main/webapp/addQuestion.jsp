...
<form-field>
<form action="addQuestion.com" onclick="return validateForm()">
    ...
    <div class="wrapper bg-white rounded">
        ...
        <div class="form-check w-70 d-grid  align-items-center justify-content-around options py-3">
          <div>
            ...
            <input type="text" name="option1" id="username1" />
            <input type="radio" id="True" name="option1check" value="true" required />
            <label for="True">True</label>
            <input type="radio" id="False" name="option1check" value="false"  />
            <label for="True">False</label>
             <p name="userError" class="error"></p>
          </div>
          <hr />
          <div>
            <span class="select">B )</span>
            <input type="text" name="option2" id="username2"/>
            <input type="radio" id="True" name="option2check" value="true" required/>
            <label for="True">True</label>
          ...
          <div>
            ...
            <input type="text" name="option3" id="username3" />
            <input type="radio" id="True" name="option3check" value="true" required />
            <label for="True">True</label>
          ...
          <hr />
          <div>
            <span class="select">D )</span><input type="text" name="option4" id="username4"/>
            <input type="radio" id="True" name="option4check" value="true" required/>
            <label for="True">True</label>
...
function validateForm() {
    if (username1.value == "" ||username2.value == "" ||username3.value == "" ||username4.value == "") {
      let err = document.getElementsByName("userError");
      for(let i = 0 ;i<=err.length;i++)
    	  {
    	 err[i].innerHTML= "Please Select One Options"
    	  }

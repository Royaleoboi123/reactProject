...
function EmployeeDetails() {
    ...
    const initialempDetails = { empId: "", deptId: "", salary: "", dateOfJoining: "", dateOfLeaving: "" };
    ...
    const handleSubmit = async (e) => {
        ...
        const url = `http://localhost:8080/addEmployeeDetails/${employeeValues.empId}/${employeeValues.deptId}`;
    ...
    const handleSubmit1 = async (e) => {
        ...
        const url = `http://localhost:8080/addDepartment`;
                    ...
                    <div className="row justify-content-center align-items-center" style={{}}>
                        <form onSubmit={handleSubmit} >
                            <div className="p-4 ms-5 me-5">
                                ...
                                <div className="mt-1">
                                    <label className="mt-2">Deptartment Id</label>
                                    <input
                                        className="form-control "
                                        type="number"
                                        name="deptId"
                                        placeholder="Department Id"
                                        value={employeeValues.deptId}
                                        onChange={handleChange}
                                    />
                                </div>
                                <div className="mt-3">
